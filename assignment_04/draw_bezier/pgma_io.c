...
/*
  ...
  Output:
    ...
    int I4MAT_MAX, the maximum entry of A.
*/
{
  int i;
...
/*
  ...
  Input:
    ...
    int XSIZE, YSIZE, the number of rows and columns of data.

    int MAXG, the maximum gray value.

    int *G, the array of XSIZE by YSIZE data values.
*/
{
  int i;
  int *index;
...
/*
  ...
  Output:
    ...
    int *G, the array of XSIZE by YSIZE gray values.
*/
{
  int i;
  int *indexg;
...
/*
  ...
  Input:
    ...
    char *FILE_IN_NAME, the name of the file.
...
/*
  ...
  Input:
    ...
    FILE *FILE_IN, a pointer to the file containing the data.
...
/*
  ...
  Input:
    ...
    FILE *FILE_IN, a pointer to the file.
...
/*
  ...
  Input:
    ...
    int XSIZE, YSIZE, the number of columns and rows of data.

    int MAXVAL, the maximum value allowed.

    int *GRAY, the array of XSIZE by YSIZE data values.
*/
{
  FILE *file_handle;
  int i;
...
/*
  ...
  Input:
    ...
    char *FILE_OUT_NAME, the name of the file.
...
/*
  ...
  Input:
    ...
    FILE *FILE_OUT, a pointer to the file.

    int XSIZE, YSIZE, the number of rows and columns of data.

    int *G, the array of XSIZE by YSIZE data.
*/
{
  int i;
  int *indexg;
